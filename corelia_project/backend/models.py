...
class Composer(models.Model):
    ...
    biography = models.TextField(
        blank=True, null=True, default='No Information Available, Check Back Later')
    bio_source = models.CharField(
        max_length=200, blank=True, null=True, default="")
    featured = models.BooleanField(default=False)
    composer_website = models.CharField(
        max_length=300, blank=True, null=True, default="")
    image = models.CharField(
        max_length=300, default="/static/composers/images/Default.png")
...
class Composition(models.Model):
    ...
    publisher = models.ForeignKey(
        Publisher, on_delete=models.CASCADE, blank=True, null=True, default="")
    recording_link = models.CharField(
        max_length=300, blank=True, null=True, default="")
    score_link = models.CharField(
        max_length=300, blank=True, null=True, default="")
...
class ForumPost(models.Model):
    ...
    image = models.ImageField(
        upload_to='../static/forums/images', blank=True, null=True)
